# -*- coding: utf-8 -*-
"""
Created on Fri Nov 23 22:18:36 2018
...
from keras.layers import Conv1D, MaxPooling1D, Embedding, Dropout, SimpleRNN
...
embeddings_index = {}
with open(os.path.join(GLOVE_DIR, 'glove.42B.300d.txt'),'rb') as f:
    for line in f:
        values = line.split()
        word = values[0]
